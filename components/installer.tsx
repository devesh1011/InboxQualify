...
export function Installer() {
  ...
  useEffect(() => {
    ...
    const neverShow = localStorage.getItem("InboxQualify-pwa-never-show");
  ...
  const handleDontAskAgain = () => {
    localStorage.setItem("InboxQualify-pwa-never-show", "true");
    setShowBanner(false);
  };
  ...
  return (
    ...
    >
      <h3 className="mb-2 flex flex-row items-center gap-2 font-semibold">
        ...
        Install InboxQualify
      </h3>
      <p className="mb-4 text-sm text-muted-foreground">
        {isIOS
          ? "Add InboxQualify to your home screen for quick access. Tap the share button and select 'Add to Home Screen'."
          : "Install InboxQualify on your device for quick and easy access to your bookkeeping."}
      </p>
      <div className="flex justify-end gap-2">
        ...
        <IconButton
          icon={isIOS ? <Share2Icon /> : <HardDriveDownloadIcon />}
